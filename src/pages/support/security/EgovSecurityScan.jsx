      ...
      <div className="modern-page-wrapper">
        ...
        <nav className="modern-breadcrumb">
          <div className="breadcrumb-container">
            ...
            <span className="breadcrumb-current">AI 보안 검사</span>
          </div>
        </nav>
          ...
          <main className="modern-content" id="contents">
            ...
            <section className="content-hero">
              <div className="hero-content">
                ...
                <h1 className="hero-title">AI 보안 검사</h1>
                <p className="hero-description">
                  코드 파일을 업로드하면 AI가 자동으로 <b>보안취약점</b>을 분석합니다.
                </p>
              </div>
            </section>
            ...
            <section className="content-section modern-card">
              ...
              <div className="card-content">
                <div className="upload-section">
                      ...
                      <div className="file-item">
                        <div className="file-info">
                          ...
                          <div className="file-details">
                            ...
                            {file.jobId && <span className="job-id">JobId: {file.jobId}</span>}
                          </div>
                        </div>
                        <div className="file-status">
                          {file.status === "uploading" ? (
                            <div className="status-uploading">
                              ...
                              <span>업로드 중... {file.progress || 0}%</span>
                            </div>
                          ) : file.status === "done" ? (
                  ...
                  {file && file.status === "done" && file.jobId && (
