...
import { DiffCodeCompare } from "@/components/DiffCodeCompare";
            ...
            <section className="content-section modern-card">
              <div className="card-content">
                ...
                <div className="tab-navigation">
                  {["overview","controller","service","serviceimpl","vo","reports","reports_json", "diff"].map((t) => (
                    <button
                      key={t}
                      onClick={() => setTab(t)}
                      disabled={!detail || !!err}
...
.file-name {
  ...
  color: #374151;
        ...
        /* Diff 뷰 내부에서는 절대 줄바꿈 금지 */
        .diff-viewer, .diff-viewer * {
          word-break: normal !important;
          overflow-wrap: normal !important;  /* (= word-wrap) */
        }
        /* 코드 셀 */
        .diff-viewer .diff-line,
        .diff-viewer .diff-line pre,
        .diff-viewer .diff-line code {
          white-space: pre-wrap !important;   /* 기본은 줄 유지, 필요할 때만 wrap */
          overflow-wrap: anywhere !important; /* 칸을 벗어나면 강제로 줄바꿈 */
          word-break: break-word !important;  /* 단어 단위 줄바꿈 */
        }
        .diff-viewer,
        .diff-viewer pre,
        .diff-viewer code {
        ...
        /* pre/code가 pre-wrap으로 덮여 있으면 숫자가 꺾입니다 → 고정 */
        .diff-viewer code {
          white-space: pre !important;  /* 반드시 한 줄 유지 */
        }

        /* gutter 셀 자체 */
        .diff-viewer .diff-gutter {
          width: 56px !important;     /* 2~3자리 대비 여유 폭 */
          min-width: 56px !important;
          text-align: right;
          // line-height: 1em;
          font-size: 13px;
          white-space: nowrap !important;  /* 부모 수준에서도 차단 */
          overflow: visible;               /* 필요 시 가로로 삐져나오게 */
        }

        /* gutter 내부 텍스트 노드 */
        .diff-viewer .diff-gutter > span,
        .diff-viewer .diff-gutter code,
        .diff-viewer .diff-gutter pre {
