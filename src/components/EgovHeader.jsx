          ...
          {actions.map((a, idx) => {
            ...
            if (external) {
              return (
                ...
                >
                  ...
                  <svg className="external-icon" viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            return (
              ...
              >
                <Icon theme={theme} />
                <span className="chip-label">{a.label}</span>
                <svg className="arrow-icon" viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" strokeWidth="2">
